...
2026-09-15
While searching  for a functioning link to the Texas Administrative Code (the link above loads a mostly blank page) we found mention of the [Texas Register](https://www.sos.texas.gov/texreg/index.shtml)which serves a similar purpose to the Federal Register: 
...
DONE
 ...
 - noted relevant chapters to read for these ^
 - failed to review Administrative Code, page would not load
TODO
 - find and review Administrative Code 
 - review the [Texas Commission Statues and Rules Handbook ](https://tcole.texas.gov/document/tcole-handbook-2025.pdf)and ensure the specific Codes/chapters are captured in the lists above
