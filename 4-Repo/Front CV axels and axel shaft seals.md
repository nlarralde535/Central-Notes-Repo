...
# Details
 We took the CR-V to a nearby shop to diagnose the rattling sounds coming from the front end during acceleration. Turns out both inboard CV boots are torn and flinging grease. 

# Notes from research
 - place drip pan under the transmission to catch dripping oil when removing the axels
