...
Start["`**Start**:
I walk the main streets of Kingwood with my antagonistic signs`"]
A["`**A**: People honk and throw shit at me from their cars`"]
  A_1["`**A_1**: ??`"]
B["`**B**: People walk up to me`"]
  B_1["`**B_1**: We get into a fight`"]
  B_2["`**B_2**: We have a discussion`"]
    B_2_1["`**B_2_1**: (some positive outcome)`"]
    B_2_2["`**B_2_2**: The discussion goes poorly and we get into a fight`"]
